...
class MonitoringConsolidatedStatsFilter(rest_framework.FilterSet):
    """MonitoringConsolidatedStatsFilter data.
    ...
    class Meta:
        """Meta class for `MonitoringConsolidatedStatsFilter` filter."""
...
class MonitoringConsolidatedStatsFilter2(rest_framework.FilterSet):
    """MonitoringConsolidatedStatsFilter data.
