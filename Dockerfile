...
CMD python manage.py collectstatic --no-input && python manage.py migrate && exec gunicorn --bind 0.0.0.0:$PORT --workers 1 --threads 8 --timeout 0 cmr2_api.wsgi:application
