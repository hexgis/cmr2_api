...
CMD python manage.py collectstatic --no-input && python manage.py migrate && exec gunicorn --bind 0.0.0.0:$PORT --workers 3 --threads 3 --timeout 30 cmr2_api.wsgi:application
